...
class Generator(nn.Module):
    def __init__(
        ...
        encoder_convs.append(EqualConv2d(in_channel, self.e_n_latents*self.style_dim, 4, padding=0, bias=False))    
    ...
    def get_latent(self, input):
        ...
        latent = out.view(len(input), self.e_n_latents, self.style_dim)
        return latent
